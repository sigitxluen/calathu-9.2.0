...
const char HTTP_FORM_OTHER[] PROGMEM =
  ...
  "<p><label><input id='t2' type='checkbox'%s checked><b>" D_ACTIVATE "</b></label></p>"
  "</fieldset>"
  "<br>"
...
const char HTTP_END[] PROGMEM =
  "<div style='text-align:right;font-size:11px;'><hr/><a href='https://peron.id/' target='_blank' style='color:#aaa;'>Calathu %s " D_BY " Agni Elnusa</a></div>"
  "</div>"
  "</body>"
  "</html>";
...
{
  char server[32];
  snprintf_P(server, sizeof(server), PSTR("Calathu/%s (%s)"), TasmotaGlobal.version, GetDeviceHardware().c_str());
...
void HandleInformation(void)
{
  ...
  WSContentSend_P(PSTR(D_PROGRAM_VERSION "}2%s%s"), TasmotaGlobal.version, "(eltery-T-W-Sensor)");
